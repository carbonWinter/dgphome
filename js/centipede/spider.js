(function () {
  ...
  var Spider = Centipede.Spider = function (options) {
    Centipede.MovingObject.call(this, {
      ...
      game: options.game,
      vel: [0, 0],
      radius: Centipede.squareSize * 0.875,
      color: options.color
    });
    ...
    this.image.src = "./../images/centipede/whammie-soda.svg";
  };
  ...
  Spider.prototype.setVel = function () {
    var velX = this.maxVel * Math.cos(this.dir);
    var velY = this.maxVel * Math.sin(this.dir);
    this.vel = [velX, velY];
  };
